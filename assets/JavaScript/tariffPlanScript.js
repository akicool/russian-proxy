...
cardContent.addEventListener("scroll", (e) => {
  const windowScroll = cardContent.scrollLeft || document.documentElement.scrollLeft
  const offsetWidth = cardContent.scrollWidth - cardContent.clientWidth
  const scrolled = windowScroll / offsetWidth
